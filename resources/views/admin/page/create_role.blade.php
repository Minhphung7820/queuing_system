...
@section('breadcrumb')
<i class="fas fa-angle-right"></i> Quản lý vai trò <i class="fas fa-angle-right"></i> <span style="color: #FF9138">Thêm vai trò</span>
@endsection
            ...
            <div style=" padding-right:10px;" class="row pb-2">
                <div style="border-radius: 15px;" class="col-lg-12 bg-white shadow">
                    <div class="row pt-4 pl-2 pr-2">
                        <div class="col-lg-12">
                            <div style="font-weight: bold;color:#FF7506;" class="h5">Thông tin vai trò</div>
                    ...
                    <div style="padding-right:20px;" class="row pt-2 pl-2">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nameRole" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên vai trò">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize:none ;height:150px;" name="der" class="form-control" id="exampleFormControlTextarea1" placeholder="Nhập mô tả" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 box-create-role-function-of-users">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="" value="auto" class="custom-control-input input-check-all-func-devices" id="customCheck1">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck1">Tất cả</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="1" class="custom-control-input input-each-func-devices" id="customCheck2">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck2">Thêm mới</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="2" class="custom-control-input input-each-func-devices" id="customCheck3">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role mb-4">
                                            <input type="checkbox" name="function[]" value="3" class="custom-control-input input-each-func-devices" id="customCheck4">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="" value="auto" class="custom-control-input  input-check-all-func-services" id="customCheck5">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck5">Tất cả</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="4" class="custom-control-input input-each-func-services" id="customCheck6">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck6">Thêm mới</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="5" class="custom-control-input input-each-func-services" id="customCheck7">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck7">Cập nhật</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role mb-4">
                                            <input type="checkbox" name="function[]" value="6" class="custom-control-input input-each-func-services" id="customCheck8">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="" value="auto" class="custom-control-input input-check-all-func-numbers" id="customCheck9">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck9">Tất cả</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="7" class="custom-control-input input-each-func-numbers" id="customCheck10">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck10">Cấp số mới</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="8" class="custom-control-input input-each-func-numbers" id="customCheck11">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck11">Xem chi tiết</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role mb-4">
                                            <input type="checkbox" name="function[]" value="9" class="custom-control-input input-each-func-numbers" id="customCheck12">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="" value="auto" class="custom-control-input input-check-all-func-users" id="customCheck13">
                                            <label style="color:#535261;" class="custom-control-label" for="customCheck13">Tất cả</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="10" class="custom-control-input input-each-func-users" id="customCheck14">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck14">Thêm tài khoản</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role  mb-4">
                                            <input type="checkbox" name="function[]" value="11" class="custom-control-input input-each-func-users" id="customCheck15">
                                        ...
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="" value="auto" class="custom-control-input input-check-all-func-role" id="customCheck17">
                                            <label style="color:#535261;" class="custom-control-label" for="customCheck17">Tất cả</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role">
                                            <input type="checkbox" name="function[]" value="12" class="custom-control-input input-each-func-role" id="customCheck18">
                                            <label style="color: #535261;" class="custom-control-label" for="customCheck18">Thêm vai trò</label>
                                        </div>
                                        <div class="custom-control custom-checkbox input-checkbox-function-role  mb-4">
                                            <input type="checkbox" name="function[]" value="13" class="custom-control-input input-each-func-role" id="customCheck19">
                ...
                <div class="col-lg-6 m-auto text-center pt-4 pb-4">
                    ...
                    <button style="background-color:#FF9138 ;color:#FFFFFF;border:none;width:150px;height:40px;" type="submit" class="btn btn-primary btn-add-role">Thêm</button>
                </div>
            </div>
        </form>
    </div>
