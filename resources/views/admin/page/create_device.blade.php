...
@section('breadcrumb')
<i class="fas fa-angle-right"></i> Danh sách thiết bị <i class="fas fa-angle-right"></i> <span style="color: #FF9138">Thêm thiết bị</span>
@endsection
        ...
        <form id="form-create-devices">
            <div style=" padding-right:10px;" class="row pb-2">
                    ...
                    <div class="row pt-2 pl-2 pr-2">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="codeDevices" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập mã thiết bị">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nameDevices" class="form-control" id="exampleInputPassword1" placeholder="Nhập tên thiết bị" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ipAddress" id="exampleInputPassword1" placeholder="Nhập địa chỉ IP">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="select-box-2">
                                    <div class="options-container_3 shadow">
                                        @foreach($type as $row)
                                        <div class="option_3">
                                            <input type="radio" class="radio" value="{{ $row->id }}" id="name_devices_cate_{{ $row->id }}" name="type" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tài khoản">
                    ...
                    <div class="row  pb-4 pl-2 pr-2">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" data-role="tagsinput" name="services" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập dịch vụ sử dụng">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-6 m-auto text-center pt-4 pb-4">
                    ...
                    <button style="background-color:#FF9138 ;color:#FFFFFF;border:none;width:150px;height:40px;" type="submit" class="btn btn-primary btn-add-device">Thêm thiết bị</button>
                </div>
            </div>
        </form>
    </div>
